import { DevnetRemoteConfig, StandaloneConfig, currentDir } from '../config';
...
export function parseArgs(required) {
    ...
    let cfg = new DevnetRemoteConfig();
    let env = '';
...
export class TestEnvironment {
    ...
    start = async () => {
        if (process.env.RUN_ENV_TESTS === 'true') {
            ...
            this.testConfig.dappConfig = {
                ...
                indexerWS: TestEnvironment.mapContainerPort(this.env, this.testConfig.dappConfig.indexerWS, 'counter-graphql-api'),
    ...
    static getProofServerContainer = async () => await new GenericContainer('ghcr.io/midnight-ntwrk/proof-server:2.0.7')
